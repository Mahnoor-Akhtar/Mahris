  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12">
        {/* 
          -------------------------------------------------------------
          EDITORIAL HEADER SECTION (Centered Headline & Intro)
          -------------------------------------------------------------
        */}
        <div className="max-w-3xl mx-auto text-center mb-12 lg:mb-16">
          ...
          <motion.h2
            ...
            className="text-[2.75rem] sm:text-5xl md:text-6xl lg:text-[4.25rem] xl:text-[4.75rem] font-medium tracking-[-0.045em] text-white uppercase leading-[0.98] mb-5"
          >
            DIGITAL PRODUCTS
            <br />
            WE’RE PROUD OF.
        ...
        */}
        ...
        >
          ...
          >
            {/* Navigation Controls Bar placed directly ABOVE project name */}
            <div className="flex items-center justify-between w-full mb-6 pb-4 border-b border-white/[0.08]">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    type="button"
                    onClick={handlePrev}
                    className="w-9 h-9 rounded-full bg-white/[0.03] hover:bg-white/[0.08] border border-white/15 hover:border-purple-400/60 flex items-center justify-center text-zinc-300 hover:text-white transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-400"
              ...
              <a
                href="#contact"
                className="group inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-[11px] font-semibold tracking-[0.14em] uppercase text-zinc-200 hover:text-white bg-white/[0.03] hover:bg-white/[0.07] border border-white/15 hover:border-purple-400/60 transition-all duration-300"
              >
                <span>VIEW ALL</span>
                <ArrowUpRight className="w-3 h-3 text-zinc-400 group-hover:text-purple-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform duration-300" />
              </a>
            </div>
        ...
        */}
        <div className="lg:hidden flex flex-col">
          ...
          {/* Controls Bar ABOVE Project Details */}
          <div className="flex items-center justify-between w-full mb-6 pb-4 border-b border-white/[0.08]">
            <div className="flex items-center gap-3">
              <div className="inline-flex items-center gap-2">
                <span className="font-mono text-xs font-bold tracking-widest text-[#A78BFA]">
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold tracking-[0.14em] uppercase text-zinc-200 bg-white/[0.03] border border-white/15"
            >
              <span>VIEW ALL</span>
